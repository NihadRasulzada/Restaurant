    ...
    public partial class Init1 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ChefDesignations", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ChefDesignationId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Chefs_ChefDesignations_ChefDesignationId",
                        column: x => x.ChefDesignationId,
                        principalTable: "ChefDesignations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChefDesignations_Name",
                table: "ChefDesignations",
                column: "Name",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Chefs_ChefDesignationId",
                table: "Chefs",
                column: "ChefDesignationId");
        }
